...
<head>
    ...
    <!--====== Title ======-->
    <title>Welcome to cbc bank</title>

    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="{{ asset('landing') }}/assets/images/logo1.png" type="image/png">
...
<body>
    <!--[if IE]>
    <p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="{{ asset('landing') }}/https://browsehappy.com/">upgrade your browser</a> to improve your experience and security.</p>
  <![endif]-->
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="{{ asset('landing') }}/index.html">
                                <img src="{{ asset('AD') }}/images/logo/cbc.jpg" alt="Logo">
                            </a>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav m-auto">
                                    <li class="nav-item active">
                                        <a href="{{ asset('landing') }}/#home">Home</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ asset('landing') }}/#actualite">Actualités </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ asset('landing') }}/#services">Services</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ asset('landing') }}/#portfolio">Portfolio</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ asset('landing') }}/#blog">Blog</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ asset('landing') }}/#contact">Contact</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->

                            <div class="navbar-btn d-none d-sm-inline-block">
                                <a class="main-btn pl-5 pr-5 btn btn-warning h3 text-white" href="{{ route('login') }}">login</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center" style="background-image: url({{ asset('landing') }}/assets/images/bg.jpeg);background-size:100%;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                         <!-- header hero content -->
            ...
            <div class="header-hero-image d-flex align-items-center wow fadeInRightBig ml-3" data-wow-duration="1s" data-wow-delay="1.1s">
                <div class="header-hero-content bg-white p-5">
                            <h1 class="hero-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"><b>Bienvenue sur notre</b> <span>Mutuelle</span>  <b>CBC BANK.</b></h1>
                            <p class="text wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">Nous sommes une communauté de passionnés... <br> Avec nous vous touchez le ciel</p>
    ...
    <!--====== TESTIMONIAL PART START ======--><section id="actualite" class="testimonial-area pt-70 pb-120 bg-dark">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-5 col-lg-6">
                    <div class="testimonial-left-content mt-45 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="section-title">
                            <h6 class="sub-title">Actualités</h6>
                            <h4 class="title text-white">Nos acttualités recentes</h4>
                        </div> <!-- section title -->
                        ...
                        <p class="text">
                            <figure>
                                <img src="{{ asset('landing') }}/assets/images/bg.jpg" alt="" srcset="">
                            </figure>
                        </p>
                        ...
                        <div class="testimonial-content-wrapper testimonial-active">
                            <div class="single-testimonial">
                                <div class="testimonial-text">
                                    <p class="text">
                                        <figure>
                                            <img src="{{ asset('landing') }}/assets/images/bg.jpg" alt="author">
                                        </figure>
                                    </p>
                                </div>
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur dignissimos harum at iste enim earum sed? Iste libero perspiciatis.</p>
                                    </div>
                                </div>
                            ...
                            <div class="single-testimonial">
                                <div class="testimonial-text">
                                    <p class="text">
                                        <figure>
                                            <img src="{{ asset('landing') }}/assets/images/bg.jpeg" alt="author">
                                        </figure>
                                    </p>
                                </div>
                                <div class="testimonial-author d-sm-flex justify-content-between">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about-image mt-60 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="{{ asset('landing') }}/assets/images/about.png" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="our-services-tab pt-30">
                        <ul class="nav justify-content-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="active" id="business-tab" data-toggle="tab" href="{{ asset('landing') }}/#business" role="tab" aria-controls="business" aria-selected="true">
                                    <i class="lni-briefcase"></i> <span>Business <br> Consultancy</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a id="digital-tab" data-toggle="tab" href="{{ asset('landing') }}/#digital" role="tab" aria-controls="digital" aria-selected="false">
                                    <i class="lni-bullhorn"></i> <span>Digital <br> Marketing</span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a id="market-tab" data-toggle="tab" href="{{ asset('landing') }}/#market" role="tab" aria-controls="market" aria-selected="false">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="our-services-image mt-50">
                                            <img src="{{ asset('landing') }}/assets/images/our-service-1.jpg" alt="service">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="service-btn text-center pt-25 pb-15">
                            <a class="main-btn main-btn-2" href="{{ asset('landing') }}/#">All Services</a>
                        </div> <!-- service btn -->
                    </div>
                </div> <!-- row -->
            </div> <!-- service wrapper -->
        ...
        <div class="container">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 grid-item apps creative laptop">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('landing') }}/assets/images/protfolio-1.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('landing') }}/assets/images/protfolio-1.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('landing') }}/assets/images/protfolio-2.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('landing') }}/assets/images/protfolio-2.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps branding product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('landing') }}/assets/images/protfolio-3.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('landing') }}/assets/images/protfolio-3.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('landing') }}/assets/images/protfolio-5.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('landing') }}/assets/images/protfolio-5.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item branding creative">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('landing') }}/assets/images/protfolio-4.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('landing') }}/assets/images/protfolio-4.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
                ...
                <div class="col-lg-4 col-sm-6 grid-item apps laptop product">
                    <div class="single-gallery gallery-masonry mt-30">
                        <div class="gallery-image">
                            <img src="{{ asset('landing') }}/assets/images/protfolio-6.jpg" alt="protfolio">
                        </div>
                        <div class="gallery-icon">
                            <a class="image-popup" href="{{ asset('landing') }}/assets/images/protfolio-6.jpg">
                                <span></span>
                            </a>
                        </div>
                    </div> <!-- single gallery -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="gallery-btn mt-60 text-center">
                        <a class="main-btn" href="{{ asset('landing') }}/#">Load More</a>
                    </div>
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing text-center pricing-color-1 mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                        ...
                        <div class="pricing-btn pt-70">
                            <a class="main-btn main-btn-2" href="{{ asset('landing') }}/#">Sign Up Now !</a>
                        </div>
                    </div> <!-- single pricing -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing text-center pricing-active pricing-color-2 mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                        ...
                        <div class="pricing-btn pt-70">
                            <a class="main-btn" href="{{ asset('landing') }}/#">Sign Up Now !</a>
                        </div>
                    </div> <!-- single pricing -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-9">
    ...
    {{-- <section id="actualite" class="testimonial-area pt-70 pb-120">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-5 col-lg-6">
                    <div class="testimonial-left-content mt-45 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s">
                        ...
                        <div class="testimonial-content-wrapper testimonial-active">
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="{{ asset('landing') }}/assets/images/author-2.jpg" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                                            <span class="sub-title">CEO, Alphabet</span>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="{{ asset('landing') }}/assets/images/author-3.jpg" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">John Doe</h5>
                                            <span class="sub-title">CEO, Alphabet</span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.4s">
                        <div class="blog-image">
                            <a href="{{ asset('landing') }}/blog-details.html"><img src="{{ asset('landing') }}/assets/images/news-1.jpg" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="{{ asset('landing') }}/blog-details.html">Nulla eget urna at tortor  turpi feugiat tristique in sit.</a></h4>
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="0.7s">
                        <div class="blog-image">
                            <a href="{{ asset('landing') }}/blog-details.html"><img src="{{ asset('landing') }}/assets/images/news-2.jpg" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="{{ asset('landing') }}/blog-details.html">Nulla eget urna at tortor  turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
                ...
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="single-blog mt-30 wow fadeInUpBig" data-wow-duration="1s" data-wow-delay="1s">
                        <div class="blog-image">
                            <a href="{{ asset('landing') }}/blog-details.html"><img src="{{ asset('landing') }}/assets/images/news-3.jpg" alt="news"></a>
                        </div>
                        <div class="blog-content">
                            <h4 class="blog-title"><a href="{{ asset('landing') }}/blog-details.html">Nulla eget urna at tortor  turpi feugiat tristique in sit.</a></h4>
                            <div class="blog-author d-flex align-items-center">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-1 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">148, avenue du General de Gaulle.</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-2 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">cbc_aicharequest@groupecommercialbank.com</p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-contact-info contact-color-3 mt-30 d-flex  wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.9s">
                            ...
                            <div class="contact-info-content media-body">
                                <p class="text">(+237) 691 74 11 07</p>
                                <p class="text">(+237) 233 43 38 00</p>
                            </div>
                        </div> <!-- single contact info -->
                    </div>
                </div> <!-- row -->
    ...
    <footer id="footer" class="footer-area bg_cover bg-dark" style="background-image: url({{ asset('landing') }}/assets/images/footer-bg.jpg)">
        <div class="container">
            <div class="footer-widget pt-30 pb-70">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 order-sm-3 order-lg-2">
                        <div class="footer-link pt-40">
                            <div class="footer-title">
                                <h5 class="title text-warning">Siege Social</h5>
                            </div>
                            <ul>
                                <li><a href="#"><i class="fa fa-map-marker text-warning" aria-hidden="true"></i>  148, avenue du General de Gaulle</a></li>
                                <li><a href="#"><i class="fa fa-clock-o text-warning" aria-hidden="true"></i>  BP 4004 Douala - Cameroun</a></li>
                                <li><a href="#"><i class="fa fa-phone text-warning" aria-hidden="true"></i>  (+237) 691 74 11 07</a></li>
                                <li><a href="#"><i class="fa fa-phone-square text-warning" aria-hidden="true"></i>  (+237) 233 43 38 00</a></li>
                                <li><a href="mailto:cbc_aicharequest@groupecommercialbank.com"><i class="fa fa-envelope text-warning" aria-hidden="true"></i>  cbc_aicharequest@groupecommercialbank.com</a></li>
                            </ul>
                        </div> <!-- footer link -->
                    </div>
                    <div class="col-lg-3 col-sm-6 order-sm-4 order-lg-3">
                        <div class="footer-link pt-40">
                            <div class="footer-title">
                                <h5 class="title text-warning">La Banque</h5>
                            </div>
                            <ul>
                                <li><a href="https://commercialbank-cm.com/banque-en-ligne/"><i class="fa fa-forward text-warning" aria-hidden="true"></i>  Banque en ligne</a></li>
                                <li><a href="https://commercialbank-cm.com/rapports-annuels/"><i class="fa fa-forward text-warning" aria-hidden="true"></i>  Nos Performances</a></li>
                                <li><a href="https://commercialbank-cm.com/candidatures-spontanees/"><i class="fa fa-forward text-warning" aria-hidden="true"></i>  Carrieres</a></li>
                                <li><a href="https://commercialbank-cm.com/nos-actualites/"><i class="fa fa-forward text-warning" aria-hidden="true"></i>  Actualités</a></li>
                            </ul>
                        </div> <!-- footer link -->
                    </div>
                    <div class="col-lg-3 col-sm-6 order-sm-2 order-lg-4">
                        <div class="footer-link pt-40">
                            <div class="footer-title">
                                <h5 class="title text-warning">Accès utiles</h5>
                            </div>
                            <ul>
                                <li><a href="https://commercialbank-cm.com/devenir-client-particulier/"><i class="fa fa-arrow-right text-warning" aria-hidden="true"></i>  Devenir Client</a></li>
                                <li><a href="https://commercialbank-cm.com/ma-banque-et-moi/"><i class="fa fa-arrow-right text-warning" aria-hidden="true"></i>  Ma banque et Moi </a></li>
                                <li><a href="https://commercialbank-cm.com/conditions-de-banque/"><i class="fa fa-arrow-right text-warning" aria-hidden="true"></i>  Condition Tarifaires</a></li>
                                <li><a href="https://commercialbank-cm.com/nos-espaces-clients/"><i class="fa fa-arrow-right text-warning" aria-hidden="true"></i>  Notre reseau</a></li>
                                <li><a href="https://commercialbank-cm.com/informations-ou-reclamations/"><i class="fa fa-arrow-right text-warning" aria-hidden="true"></i>  Formulez une reclamation</a></li>
                            </ul>
                            <!-- contact -->
                        </div> <!-- footer contact -->
                    </div>
            ...
            <div class="footer-copyright text-center">
                <p class="text">© 2022 Crafted by  <a href="https://inov.cm" rel="nofollow"> inov Cameroon </a> All Rights Reserved.</p>
            </div>
        </div> <!-- container -->
    </footer>
    ...
    <a href="{{ asset('landing') }}/#" class="back-to-top"><i class="lni-chevron-up"></i></a>
